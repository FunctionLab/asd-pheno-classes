...
def get_gene_sets():
    ...
    gene_list = [all_genes, lof_genes, fmrp_genes, asd_risk_genes, brain_expressed_genes, satterstrom, sfari_genes1]
    gene_list_names = ['all_genes', 'lof_genes', 'fmrp_genes', 'asd_risk_genes', 'brain_expressed_genes', 'satterstrom', 'sfari_genes1']
