...
def volcano_LoF():
    ...
    legend_elements = [Line2D([0], [0], marker='o', color='w', 
                              label='All genes', markerfacecolor='gray', markersize=10),
                        Line2D([0], [0], marker='v', color='w', 
                               label='LoF-Intolerant', markerfacecolor='gray', markersize=10),
                        Line2D([0], [0], marker='p', color='w', 
                               label='FMRP targets', markerfacecolor='gray', markersize=10),
                        Line2D([0], [0], marker='^', color='w', 
                               label='ASD risk', markerfacecolor='gray', markersize=10),
                        Line2D([0], [0], marker='d', color='w', 
                               label='SFARI', markerfacecolor='gray', markersize=10),
                        Line2D([0], [0], marker='P', color='w', 
                               label='Satterstrom', markerfacecolor='gray', markersize=10),
                        Line2D([0], [0], marker='s', color='w', 
                               label='Brain-expressed', markerfacecolor='gray', markersize=10)]
